...
<div class="space-y-6 animate-fade-in max-w-4xl mx-auto">
    ...
    <div class="bg-white p-5 rounded-xl shadow-card border border-gray-100 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Edit Kegiatan: {{ $kegiatan->nama_kegiatan }}</h1>
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi, pagu anggaran, atau status kegiatan pembangunan.</p>
        </div>
    </div>

    {{-- Livewire Form Component --}}
    <div class="bg-white rounded-xl shadow-card border border-gray-100 p-6">
        @livewire('kegiatan-form', ['kegiatan' => $kegiatan])
    </div>
</div>
@endsection
