...
<div class="space-y-6 animate-fade-in">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6 lg:col-span-1">
            {{-- Total Score Card --}}
            <div class="bg-gradient-to-br from-simpatik-800 to-simpatik-900 rounded-xl p-6 text-white shadow-lg text-center">
                <p class="text-simpatik-200 text-sm font-medium mb-2">Nilai Akhir Monev</p>
                <h2 class="text-5xl font-black mb-3">{{ number_format($monev->skor_total, 1) }}</h2>
                <div class="inline-block px-4 py-1 rounded-full text-sm font-bold bg-white/20 border border-white/30 backdrop-blur-sm">
                    Kategori: {{ $monev->kategori }}
                </div>
                
                <div class="mt-6 pt-6 border-t border-white/20 text-left text-sm space-y-2">
                    <p class="flex justify-between"><span class="text-simpatik-200">Desa</span> <span class="font-bold">{{ $monev->desa->nama }}</span></p>
                    <p class="flex justify-between"><span class="text-simpatik-200">Tanggal Penilaian</span> <span class="font-bold">{{ $monev->tanggal_monev->format('d M Y') }}</span></p>
                    <p class="flex justify-between"><span class="text-simpatik-200">Penilai</span> <span class="font-bold">{{ $monev->user->name }}</span></p>
                </div>
            </div>
                ...
                <div class="p-5">
                    ...
                    @else
                        <div class="text-center py-6">
                            <img src="https://illustrations.popsy.co/amber/artificial-intelligence.svg" alt="AI" class="w-32 h-32 mx-auto opacity-50 mb-4">
